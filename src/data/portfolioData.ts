...
export const TIMELINE_DATA: ITimelineItem[] = [
  ...
  },
  {
    ...
    liveUrl: "https://hypersync-app.vercel.app/",
  ...
  },
  {
    ...
    title: "AI Maternity Nanny Assistant",
    category: "Side Project",
    description: "Provides personalized maternal wellness guidance, nutrition timelines, and smart symptom analysis.",
  ...
  {
    id: "builder-app",
    title: "Builder App Platform",
    category: "Side Project",
    description: "Enables developers to visually compose, customize, and export responsive UI layout blocks.",
